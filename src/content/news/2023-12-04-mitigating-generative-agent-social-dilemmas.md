...
summary_html: In their paper published on 11/07/2023 titled <a rel="noreferrer noopener" href="https://openreview.net/pdf?id=5TIdOk7XQ6" data-type="URL" data-id="https://openreview.net/pdf?id=5TIdOk7XQ6" target="_blank">Mitigating Generative Agent Social Dilemmas</a>, Julian Yocum, Phillip J.K. Christoffersen, Mehul Damani, Justin Svegliato, Dylan Hadfield-Menell, and Stuart Russell consider the design of generative agents that can overcome social dilemmas in multi-agent settings.
---
