...
slug: ai-alignment-with-changing-and-influenceable-reward-functions
date: '2024-07-23 12:04:59'
status: publish
author: chaiadmin
wp_id: 5651
original_url: https://humancompatible.ai/news/2024/07/23/ai-alignment-with-changing-and-influenceable-reward-functions/
categories:
- news
featured_image: ../../assets/featured/2024/07/ICML-logo.png
summary_html: CHAI Researchers, Micah Carroll, Davis Foote, Anand Siththaranjan, Stuart Russell, and Anca Dragan, wrote the paper, “AI Alignment with Changing and Influenceable Reward Functions” which was accepted to ICML.
---
...
Please find the paper [here](https://arxiv.org/abs/2405.17713)
