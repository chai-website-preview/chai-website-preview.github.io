---
title: 'Embracing AI That Reflects Human Values: Insights from Brian Christian''s Journey'
slug: embracing-ai-that-reflects-human-values-insights-from-brian-christians-journey
date: '2024-03-28 09:00:00'
status: publish
author: sandy
wp_id: 5160
original_url: https://humancompatible.ai/news/2024/03/28/embracing-ai-that-reflects-human-values-insights-from-brian-christians-journey/
categories:
- news
featured_image: ../../assets/featured/2024/02/2024-03-25-16.53.41-2_0.jpg
---
...
Brian Christian, a renowned author and Center for Human Compatible Artificial Intelligence (CHAI) Affiliate with a rich background in exploring the societal implications of technology, embarks on an intriguing journey at the University of Oxford. His mission? To delve into the creation of Artificial Intelligence (AI) that aligns more closely with the intricate tapestry of human values. With celebrated works like ['The Most Human Human'](https://brianchristian.org/the-most-human-human/), ['Algorithms to Live By'](https://brianchristian.org/algorithms-to-live-by/), and ['The Alignment Problem'](https://brianchristian.org/the-alignment-problem/) under his belt, Christian's pursuit is not just academic; it's a quest for a future where technology respects our deepest human aspects.
...
At Oxford, under the mentorship of [Professor Chris Summerfield](https://www.psy.ox.ac.uk/people/christopher-summerfield) and [Associate Professor Jakob Foerster](https://eng.ox.ac.uk/people/jakob-foerster/), Christian seeks to develop models that better represent what humans value, challenging the predominant view of humans as mere rational utility maximizers. By incorporating insights from cognitive science and computational neuroscience, he hopes to offer a more nuanced understanding of human decision-making, one that acknowledges our impulsiveness, emotions, and ability to re-evaluate our goals and desires.
...
[Continue here](https://www.ox.ac.uk/news/features/can-we-truly-align-ai-human-values-qa-brian-christian) to access the original article on Oxford's website.
