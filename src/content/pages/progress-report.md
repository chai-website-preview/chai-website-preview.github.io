...
This was vividly illustrated by CHAI [research](https://www.discovermagazine.com/technology/adversarial-attack-beats-near-superhuman-ai-go-player) this year showing a simple way to beat superhuman Go playing AIs. Such systems are now built using deep learning, meaning that we can’t explain how they work, and in fact they do not really “understand” Go in the traditional sense. CHAI researchers were able to beat it using a silly strategy that no human would fall for.
...
In the 12 months from May 2022 through April 2023, CHAI produced significant outputs. CHAI student researchers published 32papers. Four CHAI students completed their PhD’s and accepted or began positions at DeepMind, Berkeley AI Research, Carnegie Mellon, and a new, AI-safety focused research company called FAR.ai. CHAI’s founder and faculty director Stuart Russell gave hundreds of invited talks and media appearances, and engaged with numerous organizations creating real policy from erstwhile principles, including the EU and its constituent governments, members of US congress including senate majority leader Charles Schumer, and the OECD. CHAI Senior Scientist Jonathan Stray co-authored a [Supreme Court brief](https://cdt.org/insights/cdt-and-technologists-file-scotus-brief-urging-court-to-hold-that-section-230-applies-to-recommendations-of-content/) on social media algorithms that was cited in oral arguments before the Court ultimately agreed that making platforms liable for the speech of their users was not the correct way to regulate increasingly powerful AI in media applications.

As an organization CHAI continued to grow, adding 3 postdocs, 4 new affiliate faculty, and 2 new graduate students.
...
In October, CHAI held its first government-funded workshop, the NSF Convergence Accelerator Workshop on Provably Safe and Beneficial AI (PSBAI), with the aim of producing a research agenda towards the design, creation, and practical deployment of verifiable, well-founded AI systems.
...
- Tony Tong Wang, Adam Gleave, Tom Tseng, Nora Belrose, Kellin Pelrine, Joseph Miller, Michael D Dennis, Yawen Duan, Viktor Pogrebniak, Sergey Levine, and Stuart Russell, Adversarial policies beat superhuman Go AIs. In *Proc. ICML-23*, 2023.
...
- Scott Emmons, Caspar Oesterheld, Andrew Critch, Vincent Conitzer, and Stuart Russell, [For Learning in Symmetric Teams, Local Optima are Global Nash Equilibria](http://people.eecs.berkeley.edu/~russell/papers/icml22-symmetric.pdf). In *Proc. ICML-22*.
...
- Kenji Doya, Arisa Ema, Hiroaki Kitano, Masamichi Sakagami, and Stuart Russell, [Social impact and governance of AI and neurotechnologies](https://doi.org/10.1016/j.neunet.2022.05.012). *Neural Networks*, 152, 542-554, 2022.
...
- [If we succeed](https://people.eecs.berkeley.edu/~russell/papers/russell-daedalus22-succeed.pdf). *Daedalus*, Spring 2022, 43-57.
...
- [How to stop AI waging war on humans](https://www.thetimes.co.uk/article/how-to-stop-ai-waging-war-on-humans-sl8jmf6hn), interview by Danny Fortson, *The Times*, March 11, 2023.
- [Interview on AI](https://people.eecs.berkeley.edu/~russell/research/future/papers/stern23-interview.pdf), by Jan Christoph Wiechmann, *Die Stern*, March 19, 2023.
- [AI Expert Wants Developers to Take Responsibilities Seriously](https://www.bloomberg.com/news/videos/2023-03-30/ai-expert-wants-developers-to-take-jobs-seriously-video), interview by Ed Ludlow, *Bloomberg TV*, March 30, 2023.
- [Beyond ChatGPT: Stuart Russell on the Risks and Rewards of AI](https://www.commonwealthclub.org/events/archive/video/beyond-chatgpt-stuart-russell-risks-and-rewards-ai), interview by Jerry Kaplan, Commonwealth Club, San Francisco, and National Public Radio, April 3, 2023.
- [We must slow down the race to God-like AI](https://www.ft.com/content/03895dc4-a3b7-481e-95cc-336a524f2ac2), by Ian Hogarth, *Financial Times*, April 12, 2023.
- [Stuart Russell on why A.I. experiments must be paused](https://edition.cnn.com/videos/tech/2023/04/01/smr-experts-demand-pause-on-ai.cnn), interview by Michael Smerconish, *CNN*, April 1, 2023.
- [AI has much to offer humanity. It could also wreak terrible harm. It must be controlled.](https://www.theguardian.com/commentisfree/2023/apr/02/ai-much-to-offer-humanity-could-wreak-terrible-harm-must-be-controlled). *The Guardian*, April 2, 2023.
- [An Open Letter Asks AI Researchers To Reconsider Responsibilities](https://www.sciencefriday.com/segments/ai-open-letter-chatgpt-ethics/), interview by Ira Flatow, *NPR Science Friday*, April 7, 2023.
- [Stuart Russell calls for new approach for AI, a `civilization-ending' technology](https://news.berkeley.edu/2023/04/07/stuart-russell-calls-for-new-approach-for-ai-a-civilization-ending-technology/), by Rachel Leven, *Berkeley News*, April 7, 2023.
- [AI: Blessing Or Curse?](https://www.youtube.com/watch?v=-LpsESrSp2k), interview by Aayush Ailawadi, *India Today*, April 10, 2023.
- [AI guru Prof Stuart Russell explains why he signed a letter with Elon Musk and others to pause AI development](https://www.businesstoday.in/technology/story/exclusive-ai-guru-prof-stuart-russell-explains-why-he-signed-a-letter-with-elon-musk-and-others-to-pause-ai-development-376936-2023-04-11), by Rachna Manojkumar Dhanrajani, *Business Today* magazine, April 11, 2023.
- [Interview with Stuart Russell: Why I called for a moratorium on giant AI experiments](https://www.bjnews.com.cn/detail/168128200314925.html), interview by Chen Yikai, *Beijing News*, April 13, 2023.
- [What Keeps a Leading AI Scientist Up At Night](https://nymag.com/intelligencer/2023/04/ai-doesnt-need-consciousness-to-be-frightening.html), interview by Benjamin Hart, *New York Magazine*, April 17, 2023.
- [interview by Sophy Ridge](https://podcasts.apple.com/us/podcast/local-elections-attack-ads-and-ai-keir-starmer-and/id1201909139?i=1000611180386), *Sophy Ridge on Sunday*, Sky, April 30, 2023.
- [Artificial intelligence: Powerful AI systems 'can't be controlled' and 'are causing harm', says UK expert](https://news.sky.com/story/artificial-intelligence-powerful-ai-systems-cant-be-controlled-and-are-causing-harm-says-uk-expert-12870035), by Adam Arnold, *Sky News*, April 30, 2023.
...
- Pulkit Verma, Shashank Rao Marpally, and Siddharth Srivastava. [Discovering User-Interpretable Capabilities of Black-Box Planning Agents](https://proceedings.kr.org/2022/36/kr2022-0036-verma-et-al.pdf). *KR 2022*.
- David Krueger. [Defining and Characterizing Reward Hacking](https://arxiv.org/abs/2209.13085). *NeurIPS 2022*.
...
- Jonathan Stray, Dylan Hadfield-Menell, et al. [Building Human Values into Recommender Systems: An Interdisciplinary Synthesis](https://arxiv.org/abs/2207.10192).
- Siddharth Srivastava and Rushang Karia. [Relational Abstractions for Generalized Reinforcement Learning on Symbolic Problems](https://aair-lab.github.io/Publications/ks_ijcai22.pdf).

### Research Fellows

- Justin Svegliato, Samer Nashed, and Su Lin Blodgett. [Fairness and Sequential Decision Making: Limits, Lessons, and Opportunities](https://arxiv.org/abs/2301.05753).
- George Obaido et al. [An Interpretable Machine Learning Approach for Hepatitis B Diagnosis](https://www.mdpi.com/2076-3417/12/21/11127). *Applied Sciences.*
- Justin Svegliato et al. [Competence-Aware Systems](https://justinsvegliato.com/s/BSWWBZaij22.pdf). *Artificial Intelligence Journal*.
- Erdem Biyik and Megha Srivastava. [Assistive Teaching of Motor Control Task to Humans](https://iliad.stanford.edu/pdfs/publications/srivastava2022assistive.pdf). *NeurIPS 2022*.
...
- Micah Carroll, Dylan Hadfield-Menell, Stuart Russell, and Anca Dragan. [Estimating and Penalizing Induced Preference Shifts in Recommender Systems](https://arxiv.org/abs/2204.11966). *ICML 2022*.
- Micah Carroll, Anca Dragan, et al. Uni[MASK]: Unified Inference in Sequential Decision Problems. *NeurIPS 2022*.
- Micah Carroll, Anca Dragan, et al. [Optimal Behavior Prior: Improving Human-AI Collaboration Through Generalizable Human Models](http://arxiv.org/abs/2211.01602). *NeurIPS 2022*.
- Micah Carroll, Anca Dragan, et al. [Time-Efficient Reward Learning via visually Assisted Cluster Ranking](https://drive.google.com/file/d/1yp9Q1gV9QeHoPWK_7hJRmfNa9o7va-8K/view). *NeurIPS 2022*.

*Working Papers*

- Lawrence Chan, Buck Shlegeris, Fabien Roger, and Euan McLean. [Language Models are Better than Humans at Next-Token Prediction](https://arxiv.org/abs/2212.11281).
- Lawrence Chan, Richard Ngo, Sören Mindermann. [The Alignment Problem from a Deep Learning Perspective](https://arxiv.org/abs/2209.00626).
...
[CHAI 2022 Progress Report](/app/uploads/2022/05/CHAI-2022-Progress-Report-3.pdf)[Download](/app/uploads/2022/05/CHAI-2022-Progress-Report-3.pdf)

[CHAI 2020 Progress Report](/app/uploads/2020/11/CHAI-2020-Progress-Report-public-9-30.pdf)[Download](/app/uploads/2020/11/CHAI-2020-Progress-Report-public-9-30.pdf)
